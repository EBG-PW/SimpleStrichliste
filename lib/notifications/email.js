...
const { getApplicationTimeZone, formatApplicationDateTime } = require('@lib/timezone');
...
const buildEmail = async (task) => {
    ...
    const context = {
        ...
        t,
        tHtml,
        formatDateTime: (value, options = {}) => formatApplicationDateTime(value, language, options),
        ...(extraContext || {}),
    };
