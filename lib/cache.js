...
/**
 * Removes a Webtoken from the in-memory cache only.
 * The persistent SQL session stays intact and will be reloaded on the next request.
 * @param {String} webtoken
 */
const removeWebtokenFromCache = (webtoken) => {
    store.delete(`WT:${webtoken}`);
}
