...
class CustomError extends Error {
    ...
    /**
     * Set the client-side translation key without changing the API error message
     * @param {String} key
     */
...
class PurchaseError extends CustomError {
    /**
     * Error when a purchase fails
     * @param {String} message | The message to display to the user
     */
    constructor(message) {
        super(message);

        this.info = 'Purchase Error'
        this.reason = 'Invalid Purchase';
        this.status = 400;
...
class FilesystemError extends CustomError {
    /**
     * Error when interfacing with the FS
     * @param {String} message | The message to display to the user
     */
    constructor(message) {
        super(message);

        this.info = 'Filesystem Error'
        this.reason = 'Error while accessing the filesystem';
        this.status = 500;
