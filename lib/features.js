 ...
 * @property {Boolean} enabledByDefault Whether migrations/settings should enable the feature by default.
 ...
 * @property {Object} settings Admin settings metadata for the feature toggle.
 ...
 * local -> config/features/local, migrations -> migrations/features/<feature>, seeds -> seeds/features/<feature>.
...
/**
 * Returns only the enabled feature definitions and annotates each one with enabled: true.
 * @param {Object.<String, Boolean>} featureSettings Feature enablement map, keyed by feature name.
 * @returns {Object.<String, FeatureManifest & {enabled: Boolean}>} Enabled feature definitions keyed by feature name.
 */
...
/**
 * Returns only enabled feature definitions without adding extra fields.
 * @param {Object.<String, Boolean>} featureSettings Feature enablement map, keyed by feature name.
 * @returns {Object.<String, FeatureManifest>} Enabled feature definitions keyed by feature name.
 */
